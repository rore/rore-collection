...
|---|---|---|---|---|---|
| 1 | **Active — first priority** | Pallium Relay reliability: [wake-first Relay](https://github.com/rore/Pallium/blob/main/roadmap/features/add-wake-first-relay-delivery.md), [activation contract](https://github.com/rore/Pallium/blob/main/roadmap/features/add-relay-activation-capability-contract.md), and [readiness Work Record](https://github.com/rore/Pallium/blob/main/.agent-workflow/tasks/codex-claude-wake-production-readiness.md). The collision diagnostic shipped in [PR #186](https://github.com/rore/Pallium/pull/186); safe split-identity backlog recovery remains unfinished. | `relaydev` owns active readiness. Other reliability tracks remain visible, not implicitly assigned. | Finish hook trust/install/readiness, restore a stable supported MCP tool surface, and define evidence-gated backlog recovery without unsafe retargeting. | None. |
